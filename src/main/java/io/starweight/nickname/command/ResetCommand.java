...
public class ResetCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String arg, String[] args) {
        ...
        String oldName = new Member(target.getUniqueId()).getOldName();
        NametagsAPI.getInstance().changeTag(target, oldName);
        new Member().delMember(target.getUniqueId());
        player.sendMessage(ColorUtil.getColor("&a[닉네임] &e" + oldName + "&f으로 변경되었습니다!"));
        return false;
    }
